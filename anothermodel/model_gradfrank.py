...
class FrankWolfeOptimizer:
    ...
    def compute_gamma(self):
        # Standard step size computation: γ = 2/(t+2)
        return 2.0 / (self.iteration + 2)
    
    def solve_linear_problem(self, gradients):
        # Find vertex with minimum inner product with gradient
    ...
    def update_weights(self, losses):
        ...
        # Standard Frank-Wolfe update: w_new = (1 - γ) * w_prev + γ * s
        self.weights = (1 - gamma) * prev_weights + gamma * s
